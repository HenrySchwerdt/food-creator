    ...
    messages: [
      {
        role: "system",
        content:
          "Erstelle ein Menü für eine Woche mit italienischen und asiatischen Gerichten." +
          "Das gesamte Budget sollte" +
          weeklyCost +
          "Euro nicht überschreiten. Schreibe auch die Schritte zur Erstellung des " +
          ...
          "Wichtig ist auch, falls manche Zutaten nicht in den Produkten vorhanden sind, kannst du gerne guenstige Zutaten hinzufuegen. Vorallem Sachen wie Sossen usw. Die sollten dann aber auch auf dem Einkaufszettel stehen aber mit 'extra' makiert sein. Damit kannst du dann bessere Gerichte aus den Produkten ableiten." +
          "Achte darauf, dass auch Soßen und Gewürze auf dem Einkaufszettel stehen. Sollten keine Gewürze vorhanden sein, kannst du auch gerne Gewürze hinzufügen. Diese sollten dann aber auch auf dem Einkaufszettel stehen." +
          "Wichtig ist auch, dass du alle Produkte anschaust die in im Json mitgeliefert werden.",
      },
      {
        role: "user",
        content: `Hier sind die verfügbaren Produkte: ${JSON.stringify(products)}`,
      },
    ],
...
const createMenu = async () => {
  try {
    ...
    console.log("Url: ", process.env.REFRESH_MENU_URL);
